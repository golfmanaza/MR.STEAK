...
<div class="w3-content" style="max-width:1100px">
  ...
  <div class="w3-row w3-padding-64 w3-card-1" id="about">
    ...
    <div class="w3-col m6 w3-padding-large w3-card-4 ">
      ...
      <h5 class="w3-center">อร่อยกับ สเต็กชิ้นใหญ่ในราคาเบาๆ </h5>
      <p class="w3-large">มิสเตอร์สเต็ก สาขานี้อยู่ที่ตลาดใหม่ค่ะ เป็นห้องแถว 2 ห้องติดๆกัน มีโต๊ะให้เลือกนั่งเยอะ เก้าอี้นั่งสบาย พนักงานคอยให้บริการเยอะ ยิ้มแย้มแจ่มใสกันดี สำหรับรสชาติอาหารอร่อย สเต็กชิ้นใหญ่
...
<span class="w3-tag w3-red">ต้องลอง !</span> พอร์คชอป, ซุปข้าวโพด, ไก่ย่างสไปซี่, สเต็กหมูพริกไทยดำ 
  ...
  <div class="w3-row w3-padding-64 w3-card-2" id="menu">
    <div class="w3-col l6 w3-padding-large w3-text-green">
      ...
      <h4>ช่วงราคา</h4>
      <p class="w3-text-grey">69-229</p><br>
...
<div class="w3-display-container mySlides">
  <img src="steak3.jpg" style="width:100%">
  <div class="w3-display-middle w3-large w3-container w3-padding-16 ">

  </div>
</div>
<div class="w3-display-container mySlides"> 
  <img src="steak2.jpg" style="width:100%">
  <div class="w3-display-middle w3-large w3-container w3-padding-16 ">
  </div>
  
</div>
<div class="w3-display-container mySlides"> 
  <img src="steak5.jpg" style="width:100%">
  <div class="w3-display-middle w3-large w3-container w3-padding-16 ">
  </div>
